...
export class Main extends Phaser.State {
    ...
    createTokenButtons() {
        this.oneTokenButton = this.game.add.text(this.game.world.width / 10, this.game.world.height - 200,"1$", {font: "30px bree", fill: "#daa520", align: "center"});
        ...
        this.fiveTokenButton = this.game.add.text(this.game.world.width / 10,this.game.world.height - 150,"5$", {font: "30px bree", fill: "#daa520", align: "center"});
        ...
        this.tenTokenButton = this.game.add.text(this.game.world.width / 10,this.game.world.height - 100,"10$", {font: "30px bree", fill: "#daa520", align: "center"});
        ...
        this.twentyFiveTokenButton = this.game.add.text(this.game.world.width / 4,this.game.world.height - 200,"25$", {font: "30px bree", fill: "#daa520", align: "center"});
        ...
        this.fiftyTokenButton = this.game.add.text(this.game.world.width / 4,this.game.world.height - 150,"50$", {font: "30px bree", fill: "#daa520", align: "center"});
        ...
        this.hundredTokenButton = this.game.add.text(this.game.world.width / 4,this.game.world.height - 100,"100$", {font: "30px bree", fill: "#daa520", align: "center"});
        ...
        this.fiveHundredTokenButton = this.game.add.text(this.game.world.width / 2,this.game.world.height - 200,"500$", {font: "30px bree", fill: "#daa520", align: "center"});
    ...
    updateBet(betValue: number) {
        let betToken =  _.find(this.player.tokens, (token) => {return token.value === betValue});
        if(betToken) {
            ...
            console.log("No such token in players' tokens!");
        }
